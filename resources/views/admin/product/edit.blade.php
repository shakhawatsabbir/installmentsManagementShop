        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Eidt Product</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        @endif
                        <form class="row g-3" action="{{route('productUpdate')}}" method="post">
                            @csrf
                                    ...
                                    <div class="card-body">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-12 col-lg-6">
                                                ...
                                                <input class="form-control" type="text" name="detail_one" value="{{$product->detail_one}}">
                                            </div>
                                            <div class="col-12 col-lg-6">
                                                <label class="form-label">Details Two</label>
                                                <input class="form-control" type="text" name="detail_two" value="{{$product->detail_two}}">
                                            </div>
                                            <div class="col-12 col-lg-6">
                                                <label class="form-label">Details Three</label>
                                                <input class="form-control" type="text" name="detail_three" value="{{$product->detail_three}}">
                                            </div>
                                            <div class="col-12 col-lg-6">
                                                <label class="form-label">Details Four</label>
                                                <input class="form-control" type="text" name="detail_four" value="{{$product->detail_four}}">
                                            </div>
                                ...
                                <div class="card shadow-none bg-light border">
                                    <div class="card-body">
                                        ...
                                        <div class="col-12 ">
                                                ...
                                                <input type="number" class="form-control" name="buy_price" placeholder="Buying Price"  value="{{$product->buy_price}}">
                                            </div>
                                        <div class="col-12 ">
                                                <label class="form-label">Delar Name</label>
                                                <input type="text" class="form-control" name="delar_name" placeholder="Delar Name"  value="{{$product->delar_name}}">
                                            </div>
                                            <div class="col-12 ">
                                            ...
                                            <div class="col-12 ">
                                                ...
                                                <input type="number" class="form-control" name="quantity" placeholder="Quantity" value="{{$product->qty}}">
                                            </div>
                                            <div class="col-12">
