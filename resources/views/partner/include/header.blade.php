    ...
    <nav class="navbar navbar-expand">
        ...
        <div class="top-navbar d-none d-xl-block">
            <ul class="navbar-nav align-items-center">
                <li class="nav-item">
                    <a class="nav-link" href="{{route('partnerHome')}}">Home</a>
                </li>
                ...
                <li class="nav-item dropdown dropdown-large">
                    <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" data-bs-toggle="dropdown">
                        <div class="user-setting d-flex align-items-center gap-1">
                            ...
                            <div class="user-name d-none d-sm-block">{{$partner_name}}</div>
                        </div>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li>
                            <a class="dropdown-item" href="{{route('partnerProfile')}}">
                                <div class="d-flex align-items-center">
                        ...
                        <li>
                            <a class="dropdown-item" href="{{route('partnerHome')}}">
                                <div class="d-flex align-items-center">
                        ...
                        <li><hr class="dropdown-divider"></li>
                        <li>
                            <a class="dropdown-item" href="{{route('logoutPartner')}}">
                                <div class="d-flex align-items-center">
